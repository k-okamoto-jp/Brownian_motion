...
plt.rcParams[
    'animation.ffmpeg_path'] = r'C:\Users\okamoto_k\ffmpeg-20200628-4cfcfb3-win64-static\bin/ffmpeg'
...
class Simulation:
    ...
    def do_animation(self, save=False):
        ...
        fig.suptitle('TD Simulation _ coalescence of dislocations', fontsize=20)
        ...
        if save:
            FFwriter = animation.FFMpegWriter(fps=10, extra_args=['-vcodec',
                                                                  'libx264'])
            anim.save(r'C:\Users\okamoto_k\Videos\Brownian motion ver4.mp4',
                      writer=FFwriter)
        else:
            plt.show()
